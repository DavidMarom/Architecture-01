    ...
    <PageContainer darkMode={isDark}>
      <Col>
        ...
        <Row>
          ...
          {/* <Col>
            <a
              href="https://health-e.herokuapp.com/#/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
                src="https://res.cloudinary.com/dojmo7vcc/image/upload/v1665567393/davidmarom.com/th01_o9z1yb.png"
                width="270px"
                alt="th01"
                border="0"
              />
        ...
        <Row>
          <p>I'd be happy to hear from you at:</p>
          <p>054 - 8762043 | </p>
          <a href="mailto:maromdavid7@gmail.com">
            mailto:maromdavid7@gmail.com
          </a>
        </Row>
      </Col>
    </PageContainer>
